...
class ApisControllerTest < ActionController::TestCase
  ...
  test "should create api" do
    assert_difference('Api.count') do
      post :create, api: { description: @api.description, name: @api.name, path: @api.path, service_id: @api.service_id, status: @api.status, type: @api.type }
    end
  ...
  test "should update api" do
    patch :update, id: @api, api: { description: @api.description, name: @api.name, path: @api.path, service_id: @api.service_id, status: @api.status, type: @api.type }
    assert_redirected_to api_path(assigns(:api))
  end
