...
class FieldsControllerTest < ActionController::TestCase
  ...
  test "should create field" do
    assert_difference('Field.count') do
      post :create, field: { api_id: @field.api_id, description: @field.description, name: @field.name, type: @field.type }
    end
  ...
  test "should update field" do
    patch :update, id: @field, field: { api_id: @field.api_id, description: @field.description, name: @field.name, type: @field.type }
    assert_redirected_to field_path(assigns(:field))
  end
